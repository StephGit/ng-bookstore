...
var CustomerService = /** @class */ (function () {
    ...
    CustomerService.prototype.handleError = function (error, method) {
        this.notificationService.error(this.errorService.getCustomerError({ method: method, status: error.status }), 'Customer error');
...
var ErrorService = /** @class */ (function () {
    ...
    ErrorService.prototype.setCatalogErrors = function () {
        ...
        this.catalogErrors.set({ method: 'update', status: 400 }, 'The ISBN number of the book data does not match the path parameter.');
